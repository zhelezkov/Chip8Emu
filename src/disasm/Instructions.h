...
void fn_nop(std::ostream& out, const OpcodeData data) {
	out << "byte #" << data.n1 << data.n2 << std::endl;
	out << "byte #" << data.n3 << data.n4 << std::endl;
}

/// 0x00E0 - clears the screen
void fn_0x00E0(std::ostream& out, const OpcodeData data) {
...
void fn_0x00EE(std::ostream& out, const OpcodeData data) {
...
void fn_0x1nnn(std::ostream& out, const OpcodeData data) {
    out << "JP " << "#" << data.n2 << data.n3 << data.n4 << std::endl;
}

/// 0x2nnn - call subroutine at nnn
void fn_0x2nnn(std::ostream& out, const OpcodeData data) {
    out << "CALL " << "#" << data.n2 << data.n3 << data.n4 << std::endl;
}

/// 0x3xkk - skip next instruction if VX == kk
void fn_0x3xkk(std::ostream& out, const OpcodeData data) {
    out << "SE V" << data.n2 << ", " << "#" << data.n3 << data.n4 << std::endl;
}

/// 0x4xkk - skip next instruction if VX != kk
void fn_0x4xkk(std::ostream& out, const OpcodeData data) {
    out << "SNE V" << data.n2 << ", " << "#" << data.n3 << data.n4 << std::endl;
}

/// 0x5xy0 - skip next instruction if VX == VY
void fn_0x5xy0(std::ostream& out, const OpcodeData data) {
	if(data.n4 == 0)
...
/// 0x6xkk - set Vx = kk
void fn_0x6xkk(std::ostream& out, const OpcodeData data) {
    out << "LD V" << data.n2 << ", " << "#" << data.n3 << data.n4 << std::endl;
}

/// 0x7xkk - set VX += kk
void fn_0x7xkk(std::ostream& out, const OpcodeData data) {
    out << "ADD V" << data.n2 << ", " << "#" << data.n3 << data.n4 << std::endl;
}

/// 0x8xy0 - set Vx = Vy
void fn_0x8xy0(std::ostream& out, const OpcodeData data) {
    out << "LD V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 0x8xy1 - set Vx = Vx | Vy
void fn_0x8xy1(std::ostream& out, const OpcodeData data) {
    out << "OR V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 0x8xy2 - set Vx = Vx & Vy
void fn_0x8xy2(std::ostream& out, const OpcodeData data) {
    out << "AND V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 8xy3 - set Vx = Vx ^ Vy
void fn_0x8xy3(std::ostream& out, const OpcodeData data) {
    out << "XOR V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 0x8xy4 - set Vx = Vx + Vy, VF = 1 if overflow else VF = 0
void fn_0x8xy4(std::ostream& out, const OpcodeData data) {
    out << "ADD V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 0x8xy5 - set Vx = Vx - Vy, VF = 1 if not borrow else 0
void fn_0x8xy5(std::ostream& out, const OpcodeData data) {
    out << "SUB V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 8xy6 - set Vx = Vx >> 1, VF = least-significant bit
void fn_0x8xy6(std::ostream& out, const OpcodeData data) {
    out << "SHR V" << data.n2 << std::endl;
}

/// 0x8xy7 - set Vx = Vy - Vx, VF = 1 if not borrow else 0
void fn_0x8xy7(std::ostream& out, const OpcodeData data) {
    out << "SUBN V" << data.n2 << ", V" << data.n3 << std::endl;
}

/// 0x8xyE - set VX = VX << 1, VF = most-significant bit
void fn_0x8xyE(std::ostream& out, const OpcodeData data) {
    out << "SHL V" << data.n2 << std::endl;
}

/// 0x9xy0 - skip next instruction if Vx != Vy
void fn_0x9xy0(std::ostream& out, const OpcodeData data) {
	if(data.n4 == 0)
...
void fn_0x00Bn(std::ostream& out, const OpcodeData data) {
	if(data.n2 == 0)
...
void fn_0x00Cn(std::ostream& out, const OpcodeData data) {
	if(data.n2 == 0)
...
void fn_0x00FB(std::ostream& out, const OpcodeData data) {
...
void fn_0x00FC(std::ostream& out, const OpcodeData data) {
    out << "SCL" << std::endl;
}

/// 0x00FD - Quit the emulator
void fn_0x00FD(std::ostream& out, const OpcodeData data) {
...
void fn_0x00FE(std::ostream& out, const OpcodeData data) {
...
void fn_0x00FF(std::ostream& out, const OpcodeData data) {
...
void fn_0xFx30(std::ostream& out, const OpcodeData data) {
    out << "LD HF, V" << data.n2 << std::endl;
}

/// 0xFx75 - save V0...VX (X<8) in the RPL flags
void fn_0xFx75(std::ostream& out, const OpcodeData data) {
    out << "LD R, V" << data.n2 << std::endl;
}

/// FX85 - load V0...VX (X<8) from the RPL flags
void fn_0xFx85(std::ostream& out, const OpcodeData data) {
    out << "LD V" << data.n2 << ", R" << std::endl;
}

/************ Extended CHIP-8 functions ************/
//// Skip next instruction if VX > VY
void fn_0x5xy1(std::ostream& out, const OpcodeData data) {
    out << "SGT V" << data.n2 << ", V" << data.n3 << std::endl;
}

//// Skip next instruction if VX < VY
void fn_0x5xy2(std::ostream& out, const OpcodeData data) {
